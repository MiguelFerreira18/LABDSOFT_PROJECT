...
public class EventInitialization implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        if (!eventRepository.existsById("0b2f589d-b5c2-4616-958c-504eeca80e5f")) {
            ...
            event1.setStartDate(LocalDateTime.of(2025, 12, 10, 9, 0));
            event1.setEndDate(LocalDateTime.of(2025, 12, 15, 17, 0));
            event1.setLimit(10);
        ...
        if (!eventRepository.existsById("0b2f589d-b5c2-4616-958c-504eeca80e64")) {
            ...
            event6.setStartDate(LocalDateTime.of(2025, 12, 10, 9, 0));
            event6.setEndDate(LocalDateTime.of(2025, 12, 10, 17, 0));
            event6.setLimit(20);
